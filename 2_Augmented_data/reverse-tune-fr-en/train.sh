...
# building vocabulary
python ${ONMT_DIR}/preprocess.py -train_src ${DATA_DIR}/finetune.en-fr.bpe.fr \
                                 -train_tgt ${DATA_DIR}/finetune.en-fr.bpe.en \
                                 -valid_src ${DATA_DIR}/finetune.valid.en-fr.bpe.fr \
                                 -valid_tgt ${DATA_DIR}/finetune.valid.en-fr.bpe.en \
