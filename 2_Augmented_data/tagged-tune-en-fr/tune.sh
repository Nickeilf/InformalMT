...
# cat $DATA_DIR/tag/finetune.fr-en.bpe.en $DATA_DIR/tag/finetune.iwslt.en-fr.bpe.en $DATA_DIR/tag/noisy.en.bpe.src $DATA_DIR/tag/nfr.en-fr.en.bpe $DATA_DIR/tag/nfr.en-fr.mono.en.bpe $DATA_DIR/tag/mustc.en > tune.en
# cat $DATA_DIR/bpe/finetune.fr-en.bpe.fr $DATA_DIR/bpe/finetune.iwslt.en-fr.bpe.fr $DATA_DIR/bpe/noisy.fr.bpe.tgt $DATA_DIR/NFR/nfr.en-fr.fr.bpe $DATA_DIR/NFR/nfr.en-fr.mono.fr.bpe $DATA_DIR/bpe/mustc.fr > tune.fr
...
python ${ONMT_DIR}/preprocess.py -train_src $DATA_DIR/tag/finetune.en-fr.bpe.en tune.en \
                                 -train_tgt $DATA_DIR/bpe/finetune.en-fr.bpe.fr tune.fr \
                                 -train_ids mtnt other\
                                 -valid_src $DATA_DIR/tag/finetune.valid.en-fr.en \
                                 -valid_tgt $DATA_DIR/bpe/finetune.valid.en-fr.fr \
...
python ${ONMT_DIR}/train.py -word_vec_size 512 \
			    			...
			    			-world_size 1 \
			    			-gpu_ranks 0 \
				            -train_from models/tag-en-fr_step_135000.pt
