...
# cp -r ../transformer-en-fr/onmt/train.vocab.* ./onmt
# cp -r ../transformer-en-fr/models/BASE-en-fr_step_${STEP}.pt ./models

# perl $TOOL_DIR/tokenizer.perl -l en < $RAW_DATA_DIR/fine-tune/train/mustc.en > ../data/tok/mustc.en
# perl $TOOL_DIR/tokenizer.perl -l fr < $RAW_DATA_DIR/fine-tune/train/mustc.fr > ../data/tok/mustc.fr

# perl $TOOL_DIR/apply_bpe.py -i ../data/tok/mustc.en -c ${DATA_DIR}/en.bpe.50k -o ../data/bpe/mustc.en
# perl $TOOL_DIR/apply_bpe.py -i ../data/tok/mustc.fr -c ${DATA_DIR}/fr.bpe.50k -o ../data/bpe/mustc.fr
...
# building vocabulary
python ${ONMT_DIR}/preprocess.py -train_src ../data/bpe/mustc.en \
                                 -train_tgt ../data/bpe/mustc.fr \
