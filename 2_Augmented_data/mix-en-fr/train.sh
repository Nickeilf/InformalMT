...
cat ${DATA_DIR}/finetune.train.bpe.fr ../data/NFR/nfr.en-fr.fr.bpe ../data/NFR/nfr.en-fr.mono.fr.bpe > mix.fr
cat ${DATA_DIR}/finetune.train.bpe.en ../data/NFR/nfr.en-fr.en.bpe ../data/NFR/nfr.en-fr.mono.en.bpe > mix.en

python ../../shuffle.py -src mix.en -tgt mix.fr

# cat ${DATA_DIR}/finetune.en-fr.bpe.fr ../data/NFR/nfr.en-fr.fr.bpe ../data/NFR/nfr.en-fr.mono.fr.bpe > mix.fr
# cat ${DATA_DIR}/finetune.en-fr.bpe.en ../data/NFR/nfr.en-fr.en.bpe ../data/NFR/nfr.en-fr.mono.en.bpe > mix.en
