...
# perl ${TOOL_DIR}/normalize-punctuation.perl -l en < result/MTNT.detok.txt > result/MTNT.punc.txt
...
# perl ${TOOL_DIR}/normalize-punctuation.perl -l en < result/news2014.detok.txt > result/news2014.punc.txt
...
# perl ${TOOL_DIR}/normalize-punctuation.perl -l en < result/newsdiscuss2015.detok.txt > result/newsdiscuss2015.punc.txt
...
# perl ${TOOL_DIR}/normalize-punctuation.perl -l en < result/MTNT2019.detok.txt > result/MTNT2019.punc.txt
