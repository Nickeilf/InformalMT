...
# evaluation on MTNT
cat data/test.bpe.16k.fr | fairseq-interactive data/fairseq --path models/checkpoint_best.pt --beam 5 --remove-bpe --batch-size 50 --buffer-size 100 |tail -n +7| tee result/MTNT.pred.txt
...
cat data/test.bpe.16k.news2014.fr | fairseq-interactive data/fairseq --path models/checkpoint_best.pt --beam 5 --remove-bpe --batch-size 50 --buffer-size 100 |tail -n +7| tee result/news2014.pred.txt
...
cat data/test.bpe.16k.newsdiscuss2015.fr | fairseq-interactive data/fairseq --path models/checkpoint_best.pt --beam 5 --remove-bpe --batch-size 50 --buffer-size 100 |tail -n +7| tee result/newsdiscuss2015.pred.txt
...
cat data/test.bpe.16k.MTNT2019.fr | fairseq-interactive data/fairseq --path models/checkpoint_best.pt --beam 5 --remove-bpe --batch-size 50 --buffer-size 100 |tail -n +7| tee result/MTNT2019.pred.txt
