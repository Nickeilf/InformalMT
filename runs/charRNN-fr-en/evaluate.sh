...
# evaluation on MTNT
python -m sockeye.translate -m models \
                            -i ${DATA_DIR}/test.char.fr \
...
python -m sockeye.translate -m models \
                            -i ${DATA_DIR}/test.char.news2014.fr \
...
python -m sockeye.translate -m models \
                            -i ${DATA_DIR}/test.char.newsdiscuss2015.fr \
...
python -m sockeye.translate -m models \
                            -i ${DATA_DIR}/test.char.MTNT2019.fr \
