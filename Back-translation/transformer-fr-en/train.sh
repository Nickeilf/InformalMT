...
python ${ONMT_DIR}/preprocess.py -train_src ${DATA_DIR}/train.bpe.fr \
                                 -train_tgt ${DATA_DIR}/train.bpe.en \
                                 -valid_src ${DATA_DIR}/valid.bpe.fr \
                                 -valid_tgt ${DATA_DIR}/valid.bpe.en \
